        ...
        children: [
          {
            ...
            children: [
              {
                matchedFiles: [null, '/src/pages/(base)/function/inventory/index.tsx', null, null],
                name: '(base)_function_inventory',
                path: '/function/inventory',
                handle: { i18nKey: 'route.(base)_function_inventory', title: '(base)_function_inventory' }
              },
              {
